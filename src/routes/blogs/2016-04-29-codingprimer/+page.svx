...
In addition, you'd also need to learn a very important tool called _Git_. Often people do not realize it's importance till very late, and so, starting this year, all projects will be reviewed and hosted on a local Git.
...
To begin with, read some about Git and GitHub/Bitbucket/GitLab (_PLEASE_ note that Git and GitHub are very different). Start here -> [Git Tutorial Atlassian](https://www.atlassian.com/git/tutorials/). Go with the first few chapters.
