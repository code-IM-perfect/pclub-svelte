...
You have a tree _T_ (an undirected connected graph containing no cycles) of _N_ nodes rooted at node number _1_. Each node is painted either **White** or **Black** . You intend to gift this tree to your girlfriend . However , your girlfriend is rather stubborn and will accept it only if it matches the color scheme the one that she has chosen .
