...
Short for **_process status_** . Returns all _currently running processes_ running on the system.
...
Each process is assigned a _unique_ **Process ID (PID)**
...
_Example (killing firefox)_ : `pkill firef` will also do ! :D
