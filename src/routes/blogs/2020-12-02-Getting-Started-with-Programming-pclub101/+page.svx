...
![](/images/1**Y0ppgbdAbGkF88YlLDR**CA.png)
...
Some terminology in the example above — The original message is referred to as **_plaintext_** and shifted message is called **_ciphertext_**_,_ and the shifting procedure is the **_encryption_** algorithm here, and the value 3 here is the **_key_** *—* it could have been any other number.
...
![](/images/1**V**Jp13LvtVc2IiY2fp4qYw.jpeg)
...
![](/images/1**M7Wup**29RMUssCSuxKOSSQ.jpeg)
...
![](/images/1**q5Jj7MkR**1COI7AhAnO6lA.png)
...
![](/images/1**QiU6DcP**r9qWLznMw0**M**Q.png)
...
1.  Linear Regression Wiki — [https://en.wikipedia.org/wiki/Linear_regression](https://en.wikipedia.org/wiki/Linear_regression)
2.  NumPy tutorial — [https://numpy.org/devdocs/user/absolute_beginners.html](https://numpy.org/devdocs/user/absolute_beginners.html)
